...
int main(int argc, char **argv)
{
    ...
    case 2:
        switch (w_bits) {
        case 2:
            test_wmma_w2a2(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
    ...
    case 3:
        switch (w_bits) {
        case 3:
            test_wmma_w3a3(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
        default:
            printf("unsupport w%da%d\n", w_bits, x_bits);
    ...
    case 4:
        switch (w_bits) {
        case 2:
            test_wmma_w2a4(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
        case 4:
            test_wmma_w4a4(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
        default:
            printf("unsupport w%da%d\n", w_bits, x_bits);
    ...
    case 5:
        switch (w_bits) {
        case 5:
            test_wmma_w5a5(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
        default:
            printf("unsupport w%da%d\n", w_bits, x_bits);
    ...
    case 6:
        switch (w_bits) {
        case 2:
            test_wmma_w2a6(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
        case 6:
            test_wmma_w6a6(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
        default:
            printf("unsupport w%da%d\n", w_bits, x_bits);
    ...
    case 7:
        ...
        case 7:
            test_wmma_w7a7(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
    ...
    case 8:
        ...
        case 2:
            test_wmma_w2a8(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
        case 3:
            test_wmma_w3a8(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
        case 4:
            test_wmma_w4a8(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
        case 8:
            test_wmma_w8a8(x_bits, w_bits, d_x, d_w, d_x_pack, d_w_pack, m, n, k, d_out, h_out,
                           h_ref_out, warmup, repeat, quant_sign, stream);
            break;
