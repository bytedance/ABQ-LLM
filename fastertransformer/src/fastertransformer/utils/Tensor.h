...
void printPerLine(half *val, int size, std::string name, int line = -1);
void printPerLine(float *val, int size, std::string name, int line = -1);
void printPerLine(int *val, int size, std::string name, int line = -1);
