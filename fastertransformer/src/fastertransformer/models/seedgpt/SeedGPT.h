...
template<typename T>
class SeedGPT: public BaseLayer {
private:
    // meta data
    size_t               head_num_;
    ...
    SeedGPTDecoder<T>*        gpt_decoder_;
    SeedGPTContextDecoder<T>* gpt_context_decoder_;
...
protected:
    ...
    int*   context_lora_mask_buf_;
    T*     context_decoder_input_buf_;
    T*     context_decoder_pre_input_buf_;
    T*     context_decoder_normed_input_buf_;
    T*     context_decoder_output_buf_;
    T*     context_decoder_post_output_buf_;
