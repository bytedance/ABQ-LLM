...
template<typename T>
void invokeLoraMaskAddBiasResidual(T* output, const T* lora_input, const int* mask, const T* residual1, const T* bias, const T* lora_bias, const int m, const int n, cudaStream_t stream)
{
    invokeLoraMaskAddBiasResidual(output, lora_input, mask, residual1, (const T*)nullptr, bias, lora_bias, m, n, stream);
}
