...
class BaichuanV2(nn.Module):
    def __init__(self,
        ...
        # Prepare weights
        self.weights = BaichuanWeights(head_num, size_per_head, inter_size, layer_num, vocab_size,
                                    max_seq_len, tensor_para_size, pipeline_para_size, use_gptj_residual,
    ...
    def cuda(self):
        ...
        # old bytenn ft lib
        # self.model = torch.classes.FasterTransformer.Llama2Op(self.head_num, self.size_per_head, self.inter_size,
...
class ParallelBaichuanV2(nn.Module):
    def __init__(self,
                 head_num, size_per_head, inter_size,
                 vocab_size, rotary_embedding_dim, layernorm_eps,
                 start_id, end_id, layer_num,
