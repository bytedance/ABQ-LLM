...
void llama_example(const INIReader reader)
{
   ...
   read_word_list("../examples/cpp/llama/stop_words_early.csv", stop_words);
   ...
   read_start_ids(request_batch_size,
                  ...
                  end_id,
                  1,
                  "../examples/cpp/llama/start_ids_early.csv");
   ...
   gpt_weights.loadModel(model_dir);
    ...
    if (sparse) {
        ...
        gpt_weights.compress_weights(cublas_wrapper, release_dense);
    }
#endif
