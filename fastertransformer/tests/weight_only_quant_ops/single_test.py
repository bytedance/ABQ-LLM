...
if __name__ == '__main__':
    handle = TestQuantize()
    # handle.test_add_bias_interleave_int8()
    handle.test_add_bias_interleave_int4()
    exit()
    handle.test_transpose_int8()
