...
class TestGemmDequantize():
    def __init__(self):
        torch.classes.load_library("/data00/liusongwei.zju/local/lightens/FasterTransformer/build_debug/lib/libth_transformer.so")
        torch.classes.load_library("/data00/liusongwei.zju/local/lightens/FasterTransformer/build_debug/lib/libgemm_dq_unit_ops.so")
...
if __name__ == '__main__':
    handle = TestGemmDequantize()
    handle.test_fp16_int8_dequantize()
