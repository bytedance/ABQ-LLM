...
template<typename T>
struct LlamaV2DecoderLayerWeight {
public:
    LlamaV2DecoderLayerWeight() = default;
    LlamaV2DecoderLayerWeight(const int int8_mode);
    LlamaV2DecoderLayerWeight(const int  head_num,
    ...
    LlamaV2DecoderLayerWeight(const LlamaV2DecoderLayerWeight& other);
    LlamaV2DecoderLayerWeight& operator=(const LlamaV2DecoderLayerWeight& other);
...
private:
    ...
    void setWeightPtr();
    void mallocWeights();
    void copyFrom(const LlamaV2DecoderLayerWeight& other);
};
