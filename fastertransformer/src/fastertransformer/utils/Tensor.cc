...
void printPerLine(half *val, int size, std::string name, int line) {
    if (line!=-1)
    ...
    for (int i = 0; i < 3; i++) {
        printf(" %f\t", __half2float(val[i]));
    }
    std::cout << "      |||||||       ";
    for (int i = 0; i < 3; i++) {
        printf("%f\t", __half2float(val[size - 3 + i]));
    }
    std::cout << std::endl;
}

void printPerLine(float *val, int size, std::string name, int line) {
    if (line!=-1)
        std::cout << "(" << line << ") " << name << " " << std::endl;
    else
        std::cout << name << " " << std::endl;
    ...
    std::cout << "      |||||||       ";
    for (int i = 0; i < 3; i++) {
        printf("%f\t", (val[size - 3 + i]));
    }
    std::cout << std::endl;
}

void printPerLine(int *val, int size, std::string name, int line) {
    if (line!=-1)
        std::cout << "(" << line << ") " << name << " " << std::endl;
    else
        std::cout << name << " " << std::endl;
