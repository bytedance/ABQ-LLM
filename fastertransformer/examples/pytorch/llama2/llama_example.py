...
from examples.pytorch.llama2.llama import Llamav2
...
def main():
    ...
    # Prepare model.
    llama = Llamav2(head_num, size_per_head, inter_size, vocab_size, rotary_embedding, layernorm_eps,
