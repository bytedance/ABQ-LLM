...
#include "src/fastertransformer/th_op/llama2/Llama2Op.h"

namespace th = torch;
namespace ft = fastertransformer;
namespace torch_ext {

Llama2Op::Llama2Op(const int64_t            head_num,
    ...
    st_(weights[0].scalar_type())
{
    ...
    switch (st_) {
        case at::ScalarType::Float:
            ftllama = new FTLlama2<float>((size_t)head_num,
                                          (size_t)kv_head_num,
        ...
        case at::ScalarType::Half:
            ftllama = new FTLlama2<half>((size_t)head_num,
                                         (size_t)kv_head_num,
                                         (size_t)size_per_head,
                                         (size_t)inter_size,
                                         (size_t)layer_num,
...
std::vector<th::Tensor> Llama2Op::forward(th::Tensor               input_ids,
...
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::Llama2Op>("FasterTransformerLlama2Op")
#else
    torch::jit::class_<torch_ext::Llama2Op>("FasterTransformer", "Llama2Op")
#endif
        ...
        .def("forward", &torch_ext::Llama2Op::forward);